(function () {
  ...
  const rows = [
    ...
    ["Cómo dibujar en el mapa", "How to draw on the map", "Come disegnare sulla mappa", "Comment dessiner sur la carte", "Como desenhar no mapa"],
    ["Dibuja líneas, zonas, símbolos y anotaciones directamente sobre el mapa.", "Draw lines, areas, symbols, and notes directly on the map.", "Disegna linee, zone, simboli e annotazioni direttamente sulla mappa.", "Dessinez des lignes, zones, symboles et annotations directement sur la carte.", "Desenhe linhas, zonas, simbolos e anotacoes diretamente no mapa."],
    ["Traza referencias visuales sobre el terreno.", "Draw visual references on the terrain.", "Traccia riferimenti visivi sul terreno.", "Tracez des reperes visuels sur le terrain.", "Trace referencias visuais no terreno."],
